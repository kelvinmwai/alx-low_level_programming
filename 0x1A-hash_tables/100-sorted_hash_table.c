 ...
 *
 * Return: pointer to the new sorted hash table | NULL if an error occurs
 */
shash_table_t *shash_table_create(unsigned long int size)
{
	shash_table_t *ht;
...
/**
 * shash_table_set - Add a new element to sorted hash table.
 * @ht: pointer to the hash table.
 * @key: The non-empty tring to add
 ...
 * @key: The key of the associated vaalue
 *
